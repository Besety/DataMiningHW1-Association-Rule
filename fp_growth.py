                ...
                for subset in power_set:
                    if subset in self.frequent_patterns.keys():
                        ...
                        if conf >= self.minconf:
                            ...
                            print("(%s) ==> (%s) confidence= %.2f" % (" ".join(subset), frequent_minus_subset, conf))




    def print_fp(self,_minsup):
        ...
        for item in self.frequent_patterns:
            ...
            stdout.write(')')
            stdout.write('  support = '+str((self.frequent_patterns[item])/(self.threshold/_minsup))+'\n')
        stdout.write('======================================================\n')
